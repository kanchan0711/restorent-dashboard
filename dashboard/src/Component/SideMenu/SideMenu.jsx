...
const SideMenu = () => {
  return (
    <div className='bg-sideMenuBg relative h-[100] basic-20 p-4'>
      {/* logo */}
      <div className='logo mt-4 gap text-[white] flex item-center justify-center m-auto'>
            <GiHamburger className='text-[20px] ' />
            <h1 className='text-[20px] align-center justify-center font-black'>Foodie</h1>
      </div>
    
    {/* user div */}
    <div className='flex item-center justfy-center text-[white] flex-col mt-[3rem] admin'>
    ...
    <div className='mt-5 h-[14rem] w-full rounded-xl overflow-hidden'>
      <img src={map} alt='Map Image' className='object-cover h-[100%}' />
    </div>
